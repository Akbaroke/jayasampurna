...
export default function Card({ value }: { value: PropsCard }) {
  ...
  return (
    <a href={value.url} target="_blank" className="bg-white rounded-lg flex flex-col border shadow-sm hover:shadow-none hover:scale-95 transition-all duration-500" data-aos="fade-up" data-aos-delay={parseInt(value.id) * 10}>
